...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<windows_error>.freeze, [">= 0.1.4"])
  s.add_runtime_dependency(%q<bindata>.freeze, ["= 2.4.15"])
  s.add_runtime_dependency(%q<openssl-ccm>.freeze, [">= 0"])
  s.add_runtime_dependency(%q<openssl-cmac>.freeze, [">= 0"])
end
